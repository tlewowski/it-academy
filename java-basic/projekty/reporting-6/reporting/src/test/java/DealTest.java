...
public class DealTest {
    ...
    public void test2() {
            ...
            Map<String, String> map2 = new TransactionCountReporter().makeReport(listDeal);
    ...
    public void test3() throws URISyntaxException, IOException {
        ...
        Map<String, String> map2 = new TransactionCountReporter().makeReport(src.fromCSV(p));
        Assert.assertEquals(map2.get("liczba transakcji"), "3");
